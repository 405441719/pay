    ...
    a.fn.citySelect = function(b) {
        function c(b) {
            var c, d = a(b),
                ...
                f = a("ul", d);
            d.click(function() {
                a(this).toggleClass(e), f.stop(!0, !0).slideToggle(200)
            }), c = function() {
        ...
        var csa = ["请选择省份", "请选择城市", "请选择地区"];
        if(defaultaddress!=''&&defaultaddress!=null&&defaultaddress!=undefined) csa = defaultaddress;
        var d, e = {
...
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西省","海南省","四川省","贵州省","云南省","西藏省","陕西省","甘肃省","青海省","宁夏省","新疆省","香港","澳门","台湾省"]);
...
dsy.add("0_17",["武汉市","十堰市","襄樊市","荆门市","孝感市","黄冈市","鄂州市","黄石市","咸宁市","荆州市","宜昌市","随州市","省直辖市","恩施州"]);
...
dsy.add("0_19_11",["莞城区","东城区","南城区","万江区"]);
